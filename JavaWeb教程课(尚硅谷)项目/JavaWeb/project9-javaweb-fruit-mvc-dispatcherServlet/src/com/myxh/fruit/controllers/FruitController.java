...
{
    /*
    之前 FruitServlet 是一个 Servlet 组件, 那么其中的 init 方法一定会被调用, 而 init 方法内部会调用super.init()
    现在 FruitController 不是一个 Servlet 组件, 那么 init 方法不会被调用
     */
    ...
    private void add(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
    {
        ...
        // 此处需要重定向, 目的是重新给 FruitController 发请求, 重新获取 fruitList, 然后覆盖到 session 中, 使得 index.html 页面上显示的 session 中的数据是最新的
