...
public class FruitDaoImpl extends BaseDao<Fruit> implements FruitDao
{
    ...
    public void updateFruit(Fruit fruit)
    {
         ...
         */
        /*
        String sqlError = "updateError t_fruit set name = ?, price = ?, count = ?, remark = ? where id = ?";
        super.executeUpdate(sqlError, fruit.getName(), fruit.getPrice(), fruit.getCount(), fruit.getRemark(), fruit.getId());
         */
    }
