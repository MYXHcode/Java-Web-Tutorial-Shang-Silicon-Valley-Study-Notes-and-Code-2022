...
public class DispatcherServlet extends ViewBaseServlet
{
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws IOException
    {
        ...
        /*
        URL 是: http://localhost:8080/project23_javaweb_book_cart_vue_axios/page.do
        那么 servletPath 是: /page.do
        第 1 步: /page.do -> page
        第 2 步: page -> PageController
         */
        ...
        try
        {
            ...
            for (Method method : methods)
            {
                if (operate.equals(method.getName()))
                {
                    ...
                    else if (methodReturnStr.startsWith("redirect:"))    // 比如 "redirect:page.do"
                    {
                        String redirectStr = methodReturnStr.substring("redirect:".length());

                        response.sendRedirect(redirectStr);
                    }
                    else if (methodReturnStr.startsWith("json:"))    // 比如 "json:{'name':'0'}"
                    {
                    ...
                    {
                        super.processTemplate(methodReturnStr, request, response);    // 比如 "index"
                    }
                }
            }
        }
